            ...
            <div className="flex items-center gap-4">
              <Button
                ...
                className={cn(
                  ...
                  isTimerRunning && !isCompleted && "opacity-50 cursor-not-allowed",
              ...
              {isTimerRunning && !isCompleted && (
                <Button onClick={handleCancel} variant="ghost" size="sm" className="text-muted-foreground hover:text-destructive h-auto px-2 py-1">
                  <span className="glitch" data-text="Cancel">Cancel</span>
                </Button>
              )}
            </div>
